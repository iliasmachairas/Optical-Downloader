...
class SentinelScene:
    ...
    def _get_asset_url(self, band_name):
        ...
        # print(f"[Scene] Available bands: {list(assets.keys())[:10]}...") 
        ...
        if url:
            print(f"[Scene] Found URL for {band_name}: {url[:80]}...")
        else:
    ...
    def load_bands(self, band_names, res=None):
        ...
        for band_name in band_names:
            ...
            try:
                ...
                print(f"[Scene] [OK] Successfully loaded band {band_name}")
        ...
        print(f"\n[Scene] [OK] Successfully loaded {loaded_count} of {requested_count} requested bands")
        if loaded_count != loaded_count:
